...
- [`src/layout`](../src/layout/CONTRACT.md): shell wall model, vertical core, authoritative room polygons, fitted contents, light grids, navigation and reachability. Depends on core.
