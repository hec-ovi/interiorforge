...
- [`src/layout`](../src/layout/CONTRACT.md): shell wall model, vertical core, authoritative room polygons with interior exclusions, fitted contents, light grids, navigation and reachability. Depends on core.
...
- [`src/geometry`](../src/geometry/CONTRACT.md): room-polygon interior meshes, shared ceiling/soffit ownership, shaped furniture and shell-fit checks. Depends on core, glb and layout.
