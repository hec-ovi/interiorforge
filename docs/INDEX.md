...
- [`src/geometry`](../src/geometry/CONTRACT.md): room polygons with interior exclusions, planar opening returns, shared ceiling/soffit ownership, shaped furniture and shell-fit checks. Depends on core, glb and layout.
...
- [Geometry panels](../src/geometry/panels/CONTRACT.md): fixed 0.5 m corners, fitted plain fields and style palettes. Depends on core and glb; [assembly schema](../src/geometry/panels/schema/assembly.schema.json).
