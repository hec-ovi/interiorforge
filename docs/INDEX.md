...
- [`src/core`](../src/core/CONTRACT.md): seeded RNG, 2D geometry, source-frame room grids and certified swept transitions, shared types and errors; room rings, opening fields, door envelopes and core-facade policy. Depends on the Exterior blueprint contract.
