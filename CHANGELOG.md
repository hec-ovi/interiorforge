...
0.30.0: luxury, damaged and capsule panel families, fitted lit ornaments, sleeping pods, licensed furniture and bounded refuse groups. window clear fields are validated and define fitted facade lining through the published housing depth. Finished ceilings and concrete soffits have exclusive exposed-plane ownership in combined and streamed floor meshes.
